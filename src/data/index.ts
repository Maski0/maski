...
export const aboutData = [
  "Game Developer and Backend Engineer with 3+ years of experience. ",
  "Currently developing custom AI agent pipelines using LangGraph/LangChain and Retrieval-Augmented Generation (RAG) and User Based memory integrations.",
  "Tech stack includes Python (FastAPI), self-hosted Qdrant vector databases, and deployment on DigitalOcean VPS. (Lists core tools for the current project)",
  "Building interactive 2D/3D visual characters with real-time lip-syncing to serve as front-ends for these AI agents",
  "Proficient in game development (Unity, Unreal Engine) and backend technologies (Node.js, Python, Go) ",
  "Shifting focus towards backend engineering roles while open to relevant game development opportunities",
  "TLDR for Shifting focus to Backend Engineering-- During my professional experience, I encountered growing requirements for backend solutions, which sparked my interest in building and optimizing these systems.",
];
...
export const SkillsData: GraphData = {
  ...
  links: [
    ...
    { source: "Database", target: "VectorDB", value: 1 },
